                        ...
                        <%@page import="rateit.helper.ConnectionProvider" %>
                            <%@page import="dbclasses.Company_database" %>
                                <%@page contentType="text/html" pageEncoding="UTF-8" %>
                                    <% HttpSession s=request.getSession(); Company_database cd=new
                                        Company_database(ConnectionProvider.getConnection()); ArrayList<Company> list =
                                        cd.getAllCompanies();
                                        ArrayList<Company> list1 = cd.getRegisterCompanies();
                                            ArrayList<Company> list3 = cd.getPollrequets();

                                                Poll_database pd = new
                                                Poll_database(ConnectionProvider.getConnection());
                                                ArrayList<Poll> list2 = pd.getAllPoll();

                                                    Company_services_database csd = new
                                                    Company_services_database(ConnectionProvider.getConnection());
                                                        ...
                                                        <div id="container">
                                                            <section id="default_page">
                                                                <div id="LASTBOX">
                                                                    <div class="active-box">
                                                                        ...
                                                                        <h3 class="active-number">194</h3>
                                                                    </div>
                                                                    <div class="logo-cont">
                                                                    <i class="fa-solid fa-ranking-star logos"></i>
                                                                </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="active-box">
                                                                        ...
                                                                        <h3 class="active-number">945</h3>
                                                                    </div>
                                                                    <div class="logo-cont">
                                                                        <i class="fa-solid fa-users logos"></i>
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="active-box">
                                                                        ...
                                                                        <h3 class="active-number">181</h3>
                                                                    </div>
                                                                    <div class="logo-cont">
                                                                        <i class="fa-solid fa-city logos"></i>
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="active-box">
                                                                        ...
                                                                        <h3 class="active-number">20</h3>
                                                                    </div>
                                                                    <div class="logo-cont">
                                                                        <i class="fa-solid fa-file logos"></i>
                                                                    </div>
                                                                    </div>
                                                                 </div>
                                                                 <div class="sub-box">
                                                            ...
                                                            <section id="page1">
                                                                <%if (request.getParameter("aa")==null) {%>
                                                                    ...
                                                                    <%} else { int
                                                                        id=Integer.parseInt(request.getParameter("aa"));
                                                            ...
                                                            <section id="page3">
                                                                <%if (request.getParameter("id")==null) {%>
                                                                    ...
                                                                    <%} else { int
                                                                        Company_id=Integer.parseInt(request.getParameter("id"));
                                                            ...
                                                            <section id="page6">
                                                                ...
                                                                <%for (Poll e : list2) { Company_database cd1=new
                                                                    Company_database(ConnectionProvider.getConnection());
                                                            ...
                                                            <section id="page7">
                                                                <%for (Company e : list) { Company_services
                                                                    cs1=csd.getCategory(e.getCOMPANY_ID()); %>
