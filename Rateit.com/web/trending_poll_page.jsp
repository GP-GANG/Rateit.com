...
<head>
    ...
    <title>Rate It | Tranding Poll List</title>
    ...
    <link rel="stylesheet" href="css/trending_poll_page.css">
...
<body>
    ...
    <main>
        <div id="rank">
            <img class="rank_num" src="https://github.com/GP-GANG/rateit.github.io/blob/main/Other%20Files/photos/first_rank.png?raw=true" alt="#FIRST"><br>
            <img class="rank_num" src="https://github.com/GP-GANG/rateit.github.io/blob/main/Other%20Files/photos/second_rank.png?raw=true" alt="#SECOND"><br>
            <img class="rank_num" src="https://github.com/GP-GANG/rateit.github.io/blob/main/Other%20Files/photos/third_rank.png?raw=true" alt="#THIRD"><br>
        </div>
